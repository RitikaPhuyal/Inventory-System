...
<html lang="en-US">
 <head>
   ...
   <title>Sales Report Through Date</title>
...
<body>
  <?php if($results): ?>
    ...
    <input type="hidden" name="start-date" value="<?php echo isset($start_date) ? $start_date : ''; ?>">
    <input type="hidden" name="end-date" value="<?php echo isset($end_date) ? $end_date : ''; ?>">
    <button type="submit" name="submit" class="btn btn-primary">Download Sales Report</button>
</form>
